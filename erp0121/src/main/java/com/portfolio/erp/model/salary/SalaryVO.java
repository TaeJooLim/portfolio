...
public class SalaryVO {
	...
	private int salaryOvertimePay;
	private int salaryNontaxTotalcost;
	...
	public void setSalaryFood(int salaryFood) {
		this.salaryFood = salaryFood;
	}
	public int getSalaryNontaxTotalcost() {
		return salaryNontaxTotalcost;
	}
	public void setSalaryNontaxTotalcost(int salaryNontaxTotalcost) {
		this.salaryNontaxTotalcost = salaryNontaxTotalcost;
	}
	public int getSalaryOvertimePay() {
		return salaryOvertimePay;
	}
	public void setSalaryOvertimePay(int salaryOvertimePay) {
		this.salaryOvertimePay = salaryOvertimePay;
	}
