...
public class UserMessageCtr {
	...
	public ModelAndView getSendList(@RequestParam int empId, 
		...
		int listCnt = messageSrv.getSendMessageCnt(empId, searchOpt, words);
		...
		mav.addObject("msgList", messageSrv.getSendMessageList(empId, searchOpt, words, startIndex, pageSize));
	...
	public ModelAndView getFromList(@RequestParam int empId, 
		...
		int listCnt = messageSrv.getFromMessageCnt(empId, searchOpt, words);
		...
		mav.addObject("msgList", messageSrv.getFromMessageList(empId, searchOpt, words, startIndex, pageSize));
		mav.addObject("listCnt", listCnt);
		mav.addObject("pagingvo", pagingvo);
