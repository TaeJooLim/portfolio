...
public class ContractCtr {
	...
	public List<ProductVO> getContDpName(	@ModelAttribute ContractVO cvo,
											@RequestParam(defaultValue = "p_name") String searchOpt, 
											@RequestParam(defaultValue = "") String words,
											@RequestParam(defaultValue = "A") String pType) {
	
		//product 검색 값 표시
		List<ProductVO> pList = productSrv.getTypeProductList(searchOpt, words, pType, 0, 10);
		return pList;	
	}
	...
	public List<ProductVO> getContMpName(	@ModelAttribute ContractVO cvo,
		...
		List<ProductVO> pList = productSrv.getTypeProductList(searchOpt, words, "A", 0, 10);
		return pList;	
	}
	...
	public String setContDModUp(@ModelAttribute ContractVO cvo) {	
		ContractVO ccvo = cSrv.getcontDMOne(cvo.getContDocNum());
		
		cvo.setContEmpCompany(ccvo.getContEmpCompany());
		cSrv.setContDModUp(cvo);
		return "redirect:/admin/contract_list";
	}
