package com.portfolio.erp.controller.admin.approval;
...
public class ApprovalCtr {
	...
	// 미결함
	@RequestMapping("/admin/appWaiting")
	public ModelAndView getApprovalWaiting(	@RequestParam int empId, 
		...
		mav.setViewName("erp/admin/erp_approval/approval_waiting");
		return mav;
	}
	
	// 완결함
	@RequestMapping("/admin/appComplete")
	public ModelAndView getApprovalComplete(@RequestParam int empId, 
		...
		mav.setViewName("erp/admin/erp_approval/approval_complete");
		return mav;
	}
	
	// 상신함
	@RequestMapping("/admin/appSend")
	public ModelAndView getApprovalSend(@RequestParam int empId, 
		...
		mav.setViewName("erp/admin/erp_approval/approval_send");
		return mav;
	}
}
