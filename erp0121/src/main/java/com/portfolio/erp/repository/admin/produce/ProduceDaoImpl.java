...
public class ProduceDaoImpl implements ProduceDao{
	...
	public void updateQcOne(String prod_process, String prodValue, int prodId) {
		...
		/* 품질검사에 통과한 공정의 갯수 검색 */
		if(pvo.getProdProcess1() != null && pvo.getProdProcess1().equals("Y")) cnt++;
		if(pvo.getProdProcess2() != null && pvo.getProdProcess2().equals("Y")) cnt++;
		if(pvo.getProdProcess3() != null && pvo.getProdProcess3().equals("Y")) cnt++;
		if(pvo.getProdProcess4() != null && pvo.getProdProcess4().equals("Y")) cnt++;
		if(pvo.getProdProcess5() != null && pvo.getProdProcess5().equals("Y")) cnt++;
		/* 품질검사에 통과한 공정의 갯수 검색 */
