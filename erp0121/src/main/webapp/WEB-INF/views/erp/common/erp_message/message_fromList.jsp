    ...
    <div class="page_wrap bg_white noto font_14">
            <div class="main_right bg_white" style="width: 100%;">
                <div class="main_right_title p_10" style="height: 50px; border-bottom: 1px solid #ccc;">
                    <h2 class="font_18">쪽지함<i class="fas fa-chevron-right p_lr10"></i>받은 쪽지 보관함</h2>
                </div>
                <div class="main_right_info" style="padding: 30px 20px;">
                    <div class="right_top">
                        <div class="right_top_btn flex">
                        	<a onClick="window.open('${pageContext.request.contextPath}/common/message_send', '쪽지보내기', 'width=500, height=528, menubar=no, status=no, toolbar=no');">
                        	...
                        	<a href="${pageContext.request.contextPath}/common/message_fromList?empId=${sessionScope.empId}">
	                            <div class="total_list_btn m_r5" style="background-color: #33428C;">받은 쪽지</div>
                        	</a>
                        	<a href="${pageContext.request.contextPath}/common/message_sendList?empId=${sessionScope.empId}">
                            	<div class="total_list_btn m_r5" style="background-color: #d6dcec;">보낸 쪽지</div>
                            </a>
			                ...
			                <form id="" name="" action="">
				                <div class="search_grp flex m_t10">
				                	<select class="search_sel_box" id="" name="searchOpt">
				                    	...
				                    	<option value="emp_name">보낸사람</option>
                        ...
                        <div class="flex m_tb10">
                			<div>
                                <button class="rad_btn_red white_s_no" id="delFromMsgAll">선택삭제</button>
                            </div>
	                        <div class="list_comment font_14" style="width:96%; height:32px; padding: 10px 20px; background-color: #f9f9f9;">
	                           받은 쪽지가 저장됩니다.
	                        </div>
                		</div>
                    </div>
		...
		<script>
			var curHref = "/erp/admin/message_fromList?empId=${sessionScope.empId}";
