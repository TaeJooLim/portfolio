	...
	<div class="page_wrap bg_white noto font_14">
		<div class="main_right bg_white">
                ...
                <div class="main_right_title p_10" style="height: 50px; border-bottom: 1px solid #ccc;">
                    <h2 class="font_18">생산/제조관리<i class="fas fa-chevron-right p_lr10"></i>5. 워크센터관리</h2>
                </div>
                <div class="main_right_info" style="padding: 30px 20px;">
                	<div class="table_wrap_box">
                    <div class="product_reg">
                    <form action="${pageContext.request.contextPath}/user/workcenter_insert">
                        <table class="input_list">
                            ...
                            <tr>
                                ...
                                <td class="p_lr3" colspan="3">
                                    <input type="text" id="wcContract" name="wcContract" class="input_100" placeholder="비고를 입력해주세요" />
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="user_table_list m_b30">
                            <thead>
                                ...
                                <c:if test="${empty list}">
                           		<tr>
                           			<td class="weight_700" colspan="10">등록된 워크센터가 없습니다.</td>
                           		<tr>
                           		</c:if>
                           		<c:forEach var="wc" items="${list}" varStatus="status">
                                        <tr>
                                            ...
                                            <td>
                                            	<button type="button" class="s_btn_gray" onclick="wcDel(${wc.wcId})">삭제</button>
                                            </td>
                                        </tr>
                                 </c:forEach>
                                </tbody> 
...
<script>
	var curHref = "/erp/user/workcenter";
