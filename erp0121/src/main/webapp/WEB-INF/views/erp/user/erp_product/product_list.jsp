        ...
        <div class="main_right_info" style="padding: 30px 20px;">
            ...
            <div class="product_list">
	            <div class="search_wrap">
	            	<div class="total_cnt_btn_grp flex">
	            		<a href="${pageContext.request.contextPath}/user/product_list">
            ...
            <div class="">
            	<div class="flex m_tb10">
                	<div>
                    	<button type="button" class="rad_btn_blue m_r5" id="deleteAll">선택삭제</button>
                  	</div>
...
<script>
	var curHref = "/erp/user/product_list";
