                ...
                <div class="main_right_info p_20">
                    ...
                    <div class="info_table">
                        <div class="page_content ">
                            <form id="empRegFrm" action="${pageContext.request.contextPath}/user/employee_register" name="empRegFrm" method="POST" enctype="multipart/form-data">
                              <!-- 해당 사원 정보 받아오기 -->
                                    ...
                                    <div class="member_left">
                                        <div class="photo_area">
                                        	<c:choose>
                                        		...
                                        		<c:otherwise>
                                        			<!-- (있으면)사진파일 -->
                                        			<img src="${pageContext.request.contextPath}/imgUpload/${employee.empPhoto}" alt="" id=""/>
                                        		</c:otherwise>
                                        	</c:choose>
                                        </div>
