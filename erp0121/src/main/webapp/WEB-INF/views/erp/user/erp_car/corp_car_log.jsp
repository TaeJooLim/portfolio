                 ...
                 <strong>차량 번호</strong>를 선택하시면 해당 차량의 일지를 작성할 수 있습니다.
                    ...
                    <div class="m_b10 flex space_between" style="align-items:flex-end;">
                        <div class="btn_wrap float_l" style="position: relative;">
                            ...
                            <button class="btn_ivory" style="position: absolute; height: 35.49px;" onClick="location.href='${pageContext.request.contextPath}/user/corp_car_management'">차량목록</button>	                            
                        </div>
                    ...
                    <div class="w_100 white_s_no m_b30">
                        <table class="user_table_list clearfix">
                            <thead>
                                <tr>
                                    <th rowspan="2">
                            ...
                            <c:if test="${empty list}">
	                        	<tfoot>
					               <tr>
					                   <td class="weight_700" colspan="18" style="height: 100px">등록된 정보가 없습니다.</td>
					               </tr>
				            	</tfoot>
	                   		</c:if>
                        </table>
...
function setCarUse(carID){
	...
	if($("#carEndKm").val() <= $("#carStartKm").val()) {
		alert("주행거리(도착후)를 확인해주세요");
		$("#carEndKm").focus();
		$("#carEndKm").val('');
		return false;
	}
