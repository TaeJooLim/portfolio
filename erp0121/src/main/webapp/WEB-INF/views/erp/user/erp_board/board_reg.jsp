...
<c:if
	...
	<script>
		alert("전산과 외의 사용자는 접근할 수 없는 페이지입니다.\n관리자에게 문의하세요.");
		history.go(-1);
	</script>
</c:if>
<!-- 읽기 권한 처리 -->
                        ...
                        <div class="board_maker">
                            <form method="post" name="boardForm" id="boardForm">
                                <table class="input_list">
                                    ...
                                    <tr class="center">
                                        ...
                                        <td colspan="5" class="td_90 p_lr3">
                                            <input type="text" name="boardName" id="boardName" required class="input_100" maxlength="20" placeholder="게시판제목 입력시, 제목만 입력해주세요. ex)자유게시판 -> 자유" />
                                        </td>
                                ...
                                <div class="btn_grp center m_t10">
                                    ...
                                    <button class="btn_ivory" type="reset" id="boardCancel" onClick="window.location.reload()">수정취소</button>
                                </div>
                            </form>
                        </div>
                        <div class="title">
...
$("#deleteAll").click(function() {
    ...
    if( str ) {
        ...
        $(".chk:checked").each(function () {
            if($(this).attr("data-uid") < 16){
					alert("공용 게시판과 각 부서의 공지사항은 삭제할 수 없습니다. ");
					stop = true;
					return false;
                }else{
