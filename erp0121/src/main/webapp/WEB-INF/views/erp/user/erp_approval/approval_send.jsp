	...
	<div class="page_wrap bg_white noto font_14">
        ...
        <div class="main_right_info" style="padding: 30px 20px;">
            ...
            <div class="search_wrap">
	            	<div class="total_cnt_btn_grp flex">
	            		<c:choose>
	            			<c:when test="${appType eq 'V'}">
			            		<a href="${pageContext.request.contextPath}/user/appSend?empId=${sessionScope.empId}">
		                            <button type="button" class="rad_btn_blue m_r5">휴가신청서</button>
		                        </a>
	            			</c:when>
	            			<c:otherwise>
	            				<a href="${pageContext.request.contextPath}/user/appSend?empId=${sessionScope.empId}&appType=O">
	                ...
	                <form id="" name="" method="post" action="${pageContext.request.contextPath}/user/appSend?appType=${appType}&empId=${sessionScope.empId}">
