...
<!-- 읽기 권한 처리 -->
<c:if test="${sessionScope.empAuth ne 10 && sessionScope.empDepartment ne '400' && sessionScope.empHeadcheck ne 'Y'}">
	<script>
		alert("총무과 부서장 외의 사용자는 접근할 수 없는 페이지입니다.\n관리자에게 문의하세요.");
		history.go(-1);
	</script>
</c:if>
<!-- 읽기 권한 처리 -->
        ...
        <div class="page_main flex space_between">
			<div class="main_right bg_white" style="width: 100%;">
                ...
                <div class="main_right_info" style="padding: 30px 20px;">
                    <div class="table_wrap_box m_b20">
                        ...
                        <table class="user_table_list m_b30" >
                            <thead>
                            <tr>
                                <th class="" style="height: 40px;">번호</th>
                                <th class="">문서번호</th>
                                <th class="">제목</th>
                                <th class="">작성자</th>
                                <th class="">결재여부</th>
