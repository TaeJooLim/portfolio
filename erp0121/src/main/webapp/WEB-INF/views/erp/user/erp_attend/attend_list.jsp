    ...
    <div class="page_wrap bg_white noto font_14" >
        <div class="main_right bg_white" style="width: 100%;">
            <div class="main_right_title p_10" style="height: 50px; border-bottom: 1px solid #ccc;">
                <h2 class="font_18">근태관리<i class="fas fa-chevron-right p_lr10"></i>1. 나의 출퇴근현황</h2>
            </div>
        </div>
        <div class="main_right_info" style="padding: 20px 20px;">
            ...
            <div class="m_t20 attend_box">
                ...
                <div class="">
                    <table class="user_table_list center m_b30">
                        <thead>
                        ...
                        <%-- <c:if test="${empty list}">
                            <tr>
                                <td colspan="10">등록된 출퇴근 기록이 없습니다.</td>
                            </tr>
                        </c:if> --%>
                        <tbody>
                        ...
                        <c:if test="${empty list}">
		                    <tfoot>
		                        <tr>
		                            <td class="weight_700" colspan="10" style="height: 100px">등록된 출퇴근기록이 없습니다.</td>
		                        </tr>
		                    </tfoot>
	                    </c:if>
                    </table>
