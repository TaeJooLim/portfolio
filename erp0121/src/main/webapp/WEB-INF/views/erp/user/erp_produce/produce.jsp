...
<div class="page_wrap bg_white noto font_14">
    <div class="main_right bg_white" style="width: 100%;">
        <div class="main_right_title p_10" style="height: 50px; border-bottom: 1px solid #ccc;">
            <h2 class="font_18">생산/제조관리<i class="fas fa-chevron-right p_lr10"></i>6. 생산등록</h2>
        </div>
    </div>
    <div class="main_right_info" style="padding: 30px 20px;">
        ...
        <div class="product_list">
            <table class="list">
                <tr>
                    <td class="bg_gray weight_700 td_10 center" style="border:1px solid #ececec;">거래처</td>
                    <td class="p_lr3 td_15 center" style="border:1px solid #ececec;">${cvo.contClientCompany}</td>
                    <td class="bg_gray weight_700 td_10 center" style="border:1px solid #ececec;">발주일</td>
                    <td class="p_lr3 td_15 center" style="border:1px solid #ececec;">${cvo.contOrderDate}</td>
                    <td class="bg_gray weight_700 td_10 center" style="border:1px solid #ececec;">납기일</td>
                    <td class="p_lr3 td_15 center" style="border:1px solid #ececec;">${cvo.contDueDate}</td>
                    <td class="bg_gray weight_700 td_10 center" style="border:1px solid #ececec;">담당자</td>
                    <td class="p_lr3 td_15 center" style="border:1px solid #ececec;">${cvo.contDepartName} ${cvo.contEmpName} ${cvo.contPositionName}</td>
                </tr>
            </table>
        </div>
        <div class="m_t10">
