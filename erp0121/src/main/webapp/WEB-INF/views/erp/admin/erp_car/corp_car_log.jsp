        ...
        <div class="main_right_info" style="padding: 30px 20px;">
            ...
            <div class="">
                <div class="" style="width: 100%;">
                    ...
                    <div class="list_comment font_14 m_b10 p_10" style="background-color: #f9f9f9;">
                 <strong>차량 번호</strong>를 선택하시면 해당 차량의 일지를 작성할 수 있습니다.
                    ...
                    <div class="flex space_between">
	                        ...
	                        <form class="m_t10" method="post" action="${pageContext.request.contextPath}/admin/corp_car_log">
            ...
            <script>
				var curHref = "/erp/admin/corp_car_log";
