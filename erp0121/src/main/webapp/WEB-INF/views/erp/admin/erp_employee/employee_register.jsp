        ...
        <div class="page_main flex space_between" style="border-bottom: 1px solid #ccc;">
            <div class="main_right bg_white" style="width: 100%;">
                <div class="main_right_title p_10" style="height: 50px; border-bottom: 1px solid #ccc;">
                    <h2 class="font_18">인사/급여관리<i class="fas fa-chevron-right p_lr10"></i>1. 사원상세정보 입력/수정</h2>
                </div>
                <div class="main_right_info p_20">
                    ...
                    <div class="info_table">
                        <div class="page_content ">
                            <form id="empRegFrm" action="${pageContext.request.contextPath}/admin/employee_register" name="empRegFrm" method="POST" enctype="multipart/form-data">
                              <!-- 해당 사원 정보 받아오기 -->
                                ...
                                <div class="member_info flex space_between">
                                    <div class="member_left">
                                        <div class="photo_area">
                                        	<c:choose>
                                        		<c:when test="${employee.empPhoto eq null}">
		                                            <img src="${pageContext.request.contextPath}/images/people/user_img_default.jpg" alt="" id="empPhoto">
                                        		</c:when>
                                        		<c:otherwise>
                                        			<!-- (있으면)사진파일 -->
                                        			<img src="${pageContext.request.contextPath}/imgUpload/${employee.empPhoto}" alt="" id="empPhoto"/>
                                        		</c:otherwise>
                                        	</c:choose>
                                        </div>
                                    ...
                                    <div class="member_right">
                                        <table class="input_list">
                                            <tr>
                                                ...
                                                <td class="td_12 p_lr3 left">
                                                    <span class="font_12 left"><fmt:formatDate value="${employee.empRegdate}" type="date" pattern="yyyy-MM-dd" /></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empCP" id="empCP" value="${employee.empCP}" class="input_100" maxlength="13" required/>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_12 p_lr3" colspan="3">
                                                    <input type="text" name="empEmail" id="empEmail" class="input_100" value="${employee.empEmail}" maxlength="50" required />
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <select name="empNation" id="empNation" class="sel_100">
                                                    	<option value="내국인" <c:if test="${employee.empNation eq '내국인'}"> selected </c:if>>내국인</option>
                                                    	<option value="외국인" <c:if test="${employee.empNation eq '외국인'}"> selected </c:if>>외국인</option>
                                                    </select>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <select name="empBank" class="sel_100" id="empBank"  >
                                                        ...
                                                        <option value="신한" <c:if test="${employee.empBank eq '신한'}"> selected </c:if>>신한</option>
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empAccountnum" id="empAccountnum" class="input_100" required  value="${employee.empAccountnum }" maxlength="20"/>
                                                </td>
