...
<!DOCTYPE html>
<c:if test="${sessionScope.empId eq null}">
	<script>
            ...
            <nav class="flex">
                ...
                <div id="sub_menu" class="">
                    <ul id="hrMngmt" class="menu">
                        ...
                        <li><a href="${pageContext.request.contextPath}/admin/organization_chart?empDepartment=${sessionScope.empDepartment}">사내조직도</a></li>
                    ...
                    <ul id="attendMngmt" class="menu">
				         <h3>근태관리</h3>
				         <li><a href="${pageContext.request.contextPath}/admin/attend_list">출퇴근현황</a></li>
				         <li><a href="${pageContext.request.contextPath}/admin/vacation_list">휴가사용이력조회</a></li>
				         <li><a href="${pageContext.request.contextPath}/admin/vacation?empId=${sessionScope.empId}">휴가사용신청</a></li>
				         <li><a href="${pageContext.request.contextPath}/admin/business_trip_form" target="_blank">출장/외근신청서</a></li>
			      	</ul>
                    ...
                    <ul id="approvalMngmt" class="menu">
                        <h3>전자결재관리</h3>
                        <li><a href="${pageContext.request.contextPath}/admin/appWaiting?appType=V&empId=${sessionScope.empId}">미결함</a></li>
                        <li><a href="${pageContext.request.contextPath}/admin/appComplete?empId=${sessionScope.empId}">완결함</a></li>
                        <li><a href="${pageContext.request.contextPath}/admin/appSend?empId=${sessionScope.empId}">상신함</a></li>
                    </ul>
                    ...
                    <ul id="userMngmt" class="menu">
                        <h3>사용자정보관리</h3>
                        <li><a href="${pageContext.request.contextPath}/admin/my_info?empId=${sessionScope.empId}">내정보관리</a></li>
                    </ul>
                </div>
            </nav>
