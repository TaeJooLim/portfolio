...
<div class="main_right bg_white" style="width: 100%;">
	<div class="main_right_title p_10"
		...
		<h2 class="font_18">상품정보수정</h2>
	</div>
	<div class="main_right_info" style="padding: 30px 20px;">
		<form id="" name="" method="POST" action="${pageContext.request.contextPath}/admin/product_reg">
			<table class="input_list">
				...
				<tr>
					...
					<td class="p_lr3">
						<input type="text" class="input_100" id="" name="pCode" placeholder="상품코드는 상품등록시 자동생성됩니다." required readonly value="${pvo.pCode}" />
					</td>
			...
			<div class="btn-grp center m_t10">
				...
				<button type="button" class="btn_red" onClick="window.location.href='${pageContext.request.contextPath}/admin/product_list'">목록으로</button>
			</div>
		</form>
