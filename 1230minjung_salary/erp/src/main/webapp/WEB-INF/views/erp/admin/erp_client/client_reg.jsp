	                    ...
	                    <div class="table_grp flex space_between">
	                        <div class="left_tbl_grp m_r10" style="width: 25%;">
	                            <table>
	                                <tr>
	                                    ...
	                                    <td class="p_lr3">
	                                        <input type="text" id="clientCode" name="clientCode" maxlength="20" id="" class="input_100" placeholder="자동생성" readonly />
	                                    </td>
	                                </tr>
	                                <tr>
	                        ...
	                        <table>
	                            <tr>
	                                ...
	                                <td class="p_lr3">
	                                    <input type="text" name="clientLicenseNum" id="clientLicenseNum" class="input_100" placeholder="" required tabindex="2" />
	                                </td>
