                ...
                <div class="main_right_info p_20">
                    ...
                    <div class="info_table">
                        <div class="page_content">
                            <form method="POST" action="${pageContext.request.contextPath}/admin/my_info">
                              	<!-- 해당 사원 정보 받아오기 -->
                               	<input type="hidden" value="${sessionScope.empNum}"/>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <select name="empCompany" id="empCompany" class="sel_100" onFocus="this.initialSelect = this.selectedIndex;" onChange="this.selectedIndex = this.initialSelect;">
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <select name="empDepartment" id="empDepartment" class="sel_100" onFocus="this.initialSelect = this.selectedIndex;" onChange="this.selectedIndex = this.initialSelect;">
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <select class="sel_100" name="empTeam" onFocus="this.initialSelect = this.selectedIndex;" onChange="this.selectedIndex = this.initialSelect;">
                                                        <option value="1팀" <c:if test="${myInfo.empTeam eq '1팀'}"> selected </c:if>>1팀</option>
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empEnter" id="empEnter" value="${myInfo.empEnter}" class="input_100" readonly/>
                                                </td>
                                                <td class="td_8 center bg_gray weight700"><span class="req"></span>가입년월일</td>
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empRegdate" id="empRegdate" class="input_100" value="${myInfo.empRegdate}" readonly/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="td_8 center bg_gray weight700"><span class="req"></span>사번</td>
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empNum" id="empNum" value="${myInfo.empNum}" class="input_100"/>
                                                </td>
                                                <td class="td_8 center  bg_gray weight700"><span class="req"></span>사원명/성별</td>
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empName" id="empName" value="${myInfo.empName}" class="input_box" style="width: calc(100% - 31% - 2px);" readonly />
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empBirth" id="empBirth" value="${myInfo.empBirth}" class="input_100" />
                                                </td>
                                                <td class="td_8 center  bg_gray weight700"><span class="req"></span>CP</td>
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empCP" id="empCP" value="${myInfo.empCP}" class="input_100" />
                                                </td>
                                                <td class="td_8 center  bg_gray weight700">내선번호</td>
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empExtension" id="empExtension" value="${myInfo.empExtension}" class="input_100" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="td_8 center bg_gray weight700"><span class="req"></span>직급</td>
                                                <td class="td_12 p_lr3">
                                                    <select class="sel_100" name="empPosition" onFocus="this.initialSelect = this.selectedIndex;" onChange="this.selectedIndex = this.initialSelect;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empAcademy" id="empAcademy" value="${myInfo.empAcademy}" class="input_100"  />
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_12 p_lr3" colspan="3">
                                                    <input type="text" name="empEmail" id="empEmail" value="${myInfo.empEmail}" class="input_100"  />
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_12 p_lr3"> <input type="text" name="empLicense1" id="empLicense1" class="input_100" value="${myInfo.empLicense1}"  /></td>
                                                <td class="td_8 center bg_gray weight700">보유자격 2</td>
                                                <td class="td_12 p_lr3"> <input type="text" name="empLicense2" id="empLicense2" class="input_100" value="${myInfo.empLicense2}" /></td>
                                                <td class="td_8 center bg_gray weight700">보유자격 3</td>
                                                <td class="td_12 p_lr3"> <input type="text" name="empLicense3" id="empLicense3" class="input_100" value="${myInfo.empLicense3}"/></td>
                                                <td class="td_8 center bg_gray weight700">어학자격 1</td>
                                                <td class="td_12 p_lr3"> <input type="text" name="empLang1" id="empLang1" class="input_100" value="${myInfo.empLang1}"/></td>
                                                <td class="td_8 center bg_gray weight700">어학자격 2</td>
                                                <td class="td_12 p_lr3"> <input type="text" name="empLang2" id="empLang2" class="input_100" value="${myInfo.empLang2}"/></td>
                                            </tr>
                                            <tr>

                                                <td class="td_8 center bg_gray weight700">국적</td>
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empNation" id="empNation" value="${myInfo.empNation}" class="input_100"  />

                                                </td>
                                                <td class="td_8 center bg_gray weight700">우편번호</td>
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empPost" id="empPost" value="${myInfo.empPost}" class="input_100"  />
                                                </td>

                                                <td class="td_8 center bg_gray weight700">주소</td>
                                                <td colspan="5" class="td_12 p_lr3">
                                                    <input type="text" name="empAddress" id="empAddress" class="input_100"  value="${myInfo.empAddress}"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empAccountnum" id="empAccountnum" class="input_100" value="${myInfo.empAccountnum}"/>
                                                </td>
                                                <td class="td_8 center bg_gray weight700">상세주소</td>
                                                <td colspan="5" class="td_12 p_lr3">
                                                    <input type="text" name="empAddressDetail" id="empAddressDetail" class="input_100" value="${myInfo.empAddressDetail}"/>
                                                </td>
                                            </tr>
                                        </table>
