...
<div class="main_right bg_white" style="width: 100%;">
                ...
                <div class="main_right_info" style="padding: 30px 20px;">
                    <div class="">
                        ...
                        <table class="input_list">
                            ...
                            <tr>
                                ...
                                <td class="p_lr3">
                                    <input type="text" name="clientLicenseNumFk" maxlength="20" value="${m.clientLicenseNumFk}" id="clientLicenseNumFk" class="readonly input_100" required/>
                                </td>
                    ...
                    <div class="m_t10">
                      ...
                      <form id="contDMReg" name="contDMReg" method="post" action="${pageContext.request.contextPath}/admin/contract_modify">
                       <div class="flex" >
                            <table class="input_list">
                                <tr>
                         ...
                         <form id="searchfrmDM" name="searchfrmDM" method="post" action="${pageContext.request.contextPath}/admin/contract_detail_prod">
                         <input type="hidden" value="${contID}" id="contID" name="contID"/>
                         <input type="hidden" value="${contDocNum}" id="contDocNum" name="contDocNum"/>
