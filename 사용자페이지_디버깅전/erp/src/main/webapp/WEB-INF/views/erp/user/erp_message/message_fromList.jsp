    ...
    <div class="page_wrap bg_white noto font_14">
            <div class="main_right bg_white" style="width: 100%;">
                <div class="main_right_title p_10" style="height: 50px; border-bottom: 1px solid #ccc;">
                    <h2 class="font_18">쪽지<i class="fas fa-chevron-right p_lr10"></i>받은 쪽지 보관함</h2>
                </div>
                <div class="main_right_info" style="padding: 30px 20px;">
                    <div class="right_top">
                        <div class="right_top_btn flex">
                        	<a target="_blank" href="${pageContext.request.contextPath}/user/message_send">
                        ...
                        <div class="flex m_tb10">
                			<div>
                                <button class="btn_red" id="delFromMsgAll">선택삭제</button>
                            </div>
                            ...
                            <table class="list center">
                                <thead>
                                    <tr>
                                        ...
                                        <input type="checkbox" class="chk" onClick="chkAll();" id="chkAll" />
                                    </th>
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${mList}" var="mlist">
                                        <tr>
                                            ...
                                            <td class="left p_l10">
	                                            <a target="_blank" href="${pageContext.request.contextPath}/user/message_read?msgId=${mlist.msgId}&typeChk=1" <c:if test="${mlist.msgConfirm eq 'N'}">class="weight_700"</c:if>>
	                                            	${mlist.msgSubject}
	                                            </a>
	                                        </td>
