                                    ...
                                    <div class="member_right">
                                        <table class="input_list">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empNum" id="empNum" class="input_100 p_lr5" value="${employee.empNum}" readonly placeholder="자동입력" required />
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_12 p_lr3" onClick="execDaumPostcode();">
                                                    <input type="text" name="empPost" id="empPost" value="${employee.empPost}" class="input_100" maxlength="5" placeholder="우편번호를 입력해주세요" readonly/>
                                                </td>

                                                <td class="td_8 center  bg_gray weight700">주소</td>
                                                <td colspan="5" class="td_12 p_lr3">
                                                    <input type="text" name="empAddress" id="empAddress" class="input_100"  value="${employee.empAddress }" maxlength="100" readonly/>
