                ...
                <div class="table_grp w_100">
                    <table class="form_tbl w_100">
                        ...
                        <tr>
                        	...
                        	<td style="border:none;text-align:right;"><fmt:formatNumber value="${svo.empStep * 10000}" pattern="#,###"/>원</td>
                        	...
                        	<td style="border:none;text-align:right;">
                        		<c:choose>
			                    	<c:when test="${slist.empHeadcheck eq 'Y'}">
			                			<fmt:formatNumber value="100000" pattern="#,###"/>원
				                	</c:when>
                        ...
                        <tr>
                        	<td style="border:none;">연차수당</td>
                        	<td style="border:none;text-align:right;">수정필요</td>
                    ...
                    <table class="form_tbl w_100 m_t30" style="border:2px solid #000">
                    	<tr>
                    		...
                    		<td class="td_25" style="border:none;text-align:right;">수정필요</td>
                    	...
                    	<tr>
                    		...
                    		<td class="weight_700" style="text-align:right;"><fmt:formatNumber value="${svo.salaryPay - svo.salaryTotalcost}" pattern="#,###"/>원</td>
                    	</tr>
                    </table>
                </div>
            </div>
