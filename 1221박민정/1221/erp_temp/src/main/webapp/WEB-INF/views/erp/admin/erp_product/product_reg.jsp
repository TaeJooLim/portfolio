		...
		<form id="" name="" method="POST" action="${pageContext.request.contextPath}/admin/product_reg">
			<table class="input_list">
				...
				<tr>
					...
					<td class="p_lr3">
						<input type="radio" class="v_middle" id="" name="pTaxuse" value="Y" />
			...
			<div class="btn-grp center m_t10">
				<button type="submit" class="btn_blue">상품입력</button>
					...
					<tbody>
                        <c:if test="${ pCnt == 0 }">
							...
							<c:forEach items="${pList}" var="plist">
								...
								<td>${plist.pNote}</td>
								<td>
									<button type="button" class="s_btn_blue" onClick="updateProductOne(${plist.pId});">수정</button>
