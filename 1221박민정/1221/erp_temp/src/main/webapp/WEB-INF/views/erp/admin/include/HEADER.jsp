            ...
            <nav class="flex">
                ...
                <div id="sub_menu" class="">
                    <ul id="hrMngmt" class="menu">
                        <h3>인사/급여관리</h3>
                        <li><a href="${pageContext.request.contextPath}/admin/salary_list">회사정보수정</a></li>
                    ...
                    <ul id="productMngmt" class="menu">
                        ...
                        <li><a href="${pageContext.request.contextPath}/admin/product_reg">상품등록</a></li>
                    </ul>
                    ...
                    <ul id="userMngmt" class="menu">
                        <h3>사용자정보관리</h3>
                        <li><a href="${pageContext.request.contextPath}/admin/my_info">내정보 관리</a></li>
                    </ul>
