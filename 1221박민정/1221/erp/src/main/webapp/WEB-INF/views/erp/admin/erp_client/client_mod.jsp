	    ...
	    <div class="page_main flex space_between" style="border-bottom: 1px solid #ccc;">
	        <div class="main_right bg_white" style="width: 100%;">
	            <div class="main_right_title p_10" style="height: 50px; border-bottom: 1px solid #ccc;">
	                <h2 class="font_18">거래처 수정</h2>
	            </div>
	            <div class="main_right_info" style="padding: 30px 20px;">
	                <form id="frm" method="POST" action="${pageContext.request.contextPath}/admin/client_mod?clientId=${clientId}">
	                    ...
	                    <div class="table_grp flex space_between">
	                        ...
	                        <table>
	                            ...
	                            <tr>
	                                ...
	                                <td class="p_lr3">
	                                    <input type="text" name="clientPost" id="clientPost" class="input_100" value="${clientPost}" required />
	                                </td>
	                                <td class="bg_gray weight_700 center">주소</td>
	                                <td class="p_lr3" colspan="3">
	                                    <input type="text" name="clientAddress" id="clientAddress" maxlength="20" class="input_100" value="${clientAddress}" required />
	                                </td>
	                            </tr>
	                            <tr>
