...
<div class="page_wrap bg_white noto font_14">
                <div class="main_right_title p_10" style="height: 50px; border-bottom: 1px solid #ccc;">
                    <h2 class="font_18">생산/제조관리<i class="fas fa-chevron-right p_lr10"></i>4. 제품별 소요자재 및 공정관리</h2>
                </div>
                <div class="main_right_info" style="padding: 30px 20px;">
                    <div class="">
                        ...
                        <div class="flex space_between">
                            <div class="w_100 list_comment font_12 m_b10 flex" style="padding: 10px 20px; background-color: #f9f9f9;">
                        ...
                        <div class="flex space_between">
                            ...
                            <div class="">
                                <button type="button" class="btn_blue m_l3 m_t3" id="setProcessBtn" name="">공정추가</button>
                            </div>
                        </div>
		                        ...
		                        <table class="m_b10 input_list">
		                            <tr>
		                                ...
		                                <td class="p_lr3">
		                                    ...
		                                    <input type="hidden" name="empIdFk" maxlength="" id="" class="input_100" value="${sessionScope.empId}" />
		                                </td>
		                            </tr>
		                        </table>
                        	</form>
                            ...
                            <table class="list_table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>담당자</th>
                                        <th>담당자연락처</th>
                                        <th class="td_3 center">삭제</th>
                                    </tr>
                                </thead>
                                <tbody id="processList">
                                	<tr>
                                		<td colspan="9">입력된 공정이 없습니다.<td>
                                	</tr>
                                </tbody>
                            </table>
                        </div>
