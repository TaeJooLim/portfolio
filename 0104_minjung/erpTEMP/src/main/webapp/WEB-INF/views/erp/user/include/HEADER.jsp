        ...
        <header style="background-color: #148cb2;">
            ...
            <div class="logo center font_18">
                <a class="white" href="${pageContext.request.contextPath}/user_main">
                    <div class="logo_img_wrap w_100 h_100 flex flex_vc flex_hc" style="background-color: #0099a4;">
            ...
            <div class="option">
                <div class="home font_14 p_lr5">
                    <a href="${pageContext.request.contextPath}/admin_main" style="color: #CFAA9E;">
            ...
            <nav class="flex">
                ...
                <div id="sub_menu" class="">
                    ...
                    <ul id="userMngmt" class="menu">
                        <h3>사용자정보관리</h3>
                        <li><a href="${pageContext.request.contextPath}/admin/my_info?empId=${sessionScope.empId}">내정보 조회</a></li>
                    </ul>
