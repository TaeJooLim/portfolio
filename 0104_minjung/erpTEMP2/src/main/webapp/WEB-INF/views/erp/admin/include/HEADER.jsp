    ...
    <div class="w_100 h_100 bg_gray">
        <header>
            ...
            <div class="option">
                ...
                <div class="home font_14 p_lr5">
                    <a class="white" href="${pageContext.request.contextPath}/user_main">
            ...
            <nav class="flex">
                ...
                <div id="sub_menu" class="">
                    ...
                    <ul id="attendMngmt" class="menu">
                        ...
                        <li><a href="${pageContext.request.contextPath}/admin/#">휴가사용이력조회(X)</a></li>
                        <li><a href="${pageContext.request.contextPath}/admin/#">휴가사용내역조회(X)</a></li>
                        <li><a href="${pageContext.request.contextPath}/admin/#">휴가사용신청(X)</a></li>
                    </ul>
                    ...
                    <ul id="productMngmt" class="menu">
                        ...
                        <li><a href="${pageContext.request.contextPath}/admin/#">워크센터입력(X)</a></li>
                    </ul>
                    ...
                    <ul id="companyMngmt" class="menu">
                        <h3>회사정보관리</h3>
                        <li><a href="${pageContext.request.contextPath}/admin/#">회사기초정보입력(X)</a></li>
                    </ul>
                    ...
                    <ul id="boardMngmt" class="menu">
                        <h3>게시판관리</h3>
                        <li><a href="${pageContext.request.contextPath}/admin/#">게시판목록(X)</a></li>
                        <li><a href="${pageContext.request.contextPath}/admin/#">게시판생성 및 관리(X)</a></li>
                        <li><a href="${pageContext.request.contextPath}/admin/#">게시글 상세보기(X)</a></li>
                        <li><a href="${pageContext.request.contextPath}/admin/#">게시글 작성하기(X)</a></li>
                    </ul>
