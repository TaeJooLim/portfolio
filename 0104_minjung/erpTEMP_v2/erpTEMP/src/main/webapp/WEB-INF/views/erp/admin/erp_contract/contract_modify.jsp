...
<div class="main_right bg_white" style="width: 100%;">
                ...
                <div class="main_right_info" style="padding: 30px 20px;">
                    <div class="">
                        ...
                        <form action="${pageContext.request.contextPath}/admin/contract_modify_update" name="frm" id="frm" method="post"> 
                        ...
                        <table class="input_list">
                            <tr>
                                ...
                                <td class="p_lr3">
                                    <input type="text" name="contComName" value="${m.contComName}" maxlength="20" id="contComName" class=" prod_num input_100" required />
                                </td>
                                ...
                                <td class="p_lr3">
                                    <input type="text" name="contDepartName" value="${m.contDepartName}" maxlength="50" id="contDepartName" class="input_100" required />
                                </td>
                                <td class="bg_gray weight_700 td_7 center">담당자 직급</td>
                                <td class="p_lr3">
                                    <input type="text" name="contPositionName" value="${m.contPositionName}" maxlength="50" id="contPositionName" class="input_100" required />
                                </td>
                                <td class="bg_gray weight_700 td_7 center">담당자 이름</td>
                                <td class="p_lr3">
                                    <input type="text" name="contEmpName" value="${m.contEmpName}" maxlength="50" id="contEmpName" class="input_100" required />
                                </td>
                            </tr>
                            <tr>
                                <td class="bg_gray weight_700 td_7 center">거래처</td>
                                <td class="p_lr3">
                                    <input type="text" name="contClientCompany" value="${m.contClientCompany}" maxlength="50" id="contClientCompany" class="input_100" required readonly />
                                </td>
                                <td class="bg_gray weight_700 td_7 center">거래처 대표자</td>
                                <td class="p_lr3">
                                    <input type="text" name="contClientCeoName" value="${m.contClientCeoName}" maxlength="50" id="contClientCeoName" class="input_100" required />
                                </td>
                                <td class="bg_gray weight_700 td_7 center">거래처 담당자</td>
                                <td class="p_lr3">
                                    <input type="text" name="contClientResponsibility" value="${m.contClientResponsibility}" maxlength="30" id="contClientResponsibility" class="input_100" required />
                                </td>
                                <td class="bg_gray weight_700 td_7 center">거래처 연락처</td>
                                <td class="p_lr3">
                                    <input type="text" name="contClientResCp" maxlength="30" value="${m.contClientResCp}" id="contClientResCp" class="input_100" required />
                                </td>
                                <td class="bg_gray weight_700 td_7 center">거래처 이메일</td>
                                <td class="p_lr3">
                                    <input type="text" name="contClientResEmail" maxlength="30" value="${m.contClientResEmail}" id="contClientResEmail" class="input_100" required />
                                </td>
                            </tr>
                            <tr>
                            	<td class="bg_gray weight_700 td_8 center">거래처 사업장번호</td>
                                <td class="p_lr3">
                                    <input type="text" name="clientLicenseNumFk" maxlength="20" value="${m.clientLicenseNumFk}" id="clientLicenseNumFk" class="input_100" required readonly/>
                                </td>
                                ...
                                <td class="p_lr3" colspan="3">
                                    <input type="text" name="contNote" maxlength="50" value="${m.contNote}" id="contNote" class="input_100" required />
                                </td>                                
                            </tr>                            
                        </table>
                    ...
                    <div class="m_t10">
                      ...
                      <form id="contDReg" name="contDReg" method="post" action="${pageContext.request.contextPath}/admin/contract_modify">
                       <div class="flex" >
                            <table class="input_list">
                                <tr>
                                ...
                                <table class="search_list">
                                    ...
                                    <c:forEach var="p" items="${pList}">
                                        <tr>
                                            ...
                                            <td>${p.pModelnum}</td>
                                            <td>${p.pBrand}</td>
                                            <td> <button type="button" id="" class="proc_sel_btn s_btn_gray" onclick="location.href='${pageContext.request.contextPath}/admin/contract_modify?contDocNum=${contDocNum}&contDpName=${p.pName}'">선택</button> </td>
                                        </tr>
                                    </c:forEach>    
                                    </tbody>
...
$("#prod_srh").click(function() {
 ...
 function searchfrm(){
		...
		$.ajax({
				url		: "${pageContext.request.contextPath}/admin/contract_modify_prod",
				type	: "POST",
				...
				success	: function(results) {
					...
					$(".plist").hide();
					 ...
					 $.each(results , function(key, results){
			                ...
			                str += '<td> <button type="button" id="" class="proc_sel_btn s_btn_gray" onClick="procSel(\''+contDocNum+'\', \''+results.pName+'\');">선택</button> </td>';
			                str += '</tr>';
			           });
			           $("#plist").append(str);
 ...
 function procSel(contDocNum, pName){
	 window.location.href="${pageContext.request.contextPath}/admin/contract_modify?contDocNum="+contDocNum+"&contDpName="+pName;
	 }	

function conUpBtn(){
	var formData = $("#frm").serialize();
	$.ajax({
			url		: "${pageContext.request.contextPath}/admin/contract_modify_update",
			type	: "POST",
			data	: formData,
			success	: function(resdata) {
				alert( "계약서가 수정되었습니다.");
...
function contDReg(){
	...
	var formData = $("#contDReg").serialize();
		$.ajax({
			url		: "${pageContext.request.contextPath}/admin/contract_modify_insert",
			type	: "POST",
			data	: formData,
			success	: function(resdata) {
				alert( "품목이 등록되었습니다.");
				window.location.href="${pageContext.request.contextPath}/admin/contract_modify?contDocNum="+resdata;
			},
			error	:function() {
				alert("시스템 에러");			
			}
