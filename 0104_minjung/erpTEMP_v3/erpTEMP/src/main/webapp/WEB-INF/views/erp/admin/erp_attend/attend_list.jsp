    ...
    <div class="page_wrap bg_white noto font_14" style="height: 100vh;">
        ...
        <div class="main_right_info" style="padding: 20px 20px;">
	        <div class="list_title p_tb10">
         	...
         	<div class="m_b10">
            	<button type="button" class="btn_red">선택삭제</button>
            </div>
	              <div class="w_100 white_s_no overflow_x_auto m_b10">
	                ...
	                <c:forEach items="${list}" var="list" varStatus="status">
	                    <tr>
	                        ...
	                        <td>
	                        	<select class="s_sel_100" onchange="changeWorkplace(this.value,${list.attendId},'${list.empName}','${list.attendWorkdate}');">
	                        ...
	                        <td>
	                            <select class="s_sel_100" onchange="changeStatus(this.value,${list.attendId},'${list.empName}','${list.attendWorkdate}');">
