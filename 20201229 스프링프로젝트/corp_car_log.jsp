    ...
    <div class="page_wrap bg_white noto font_14" style="height: 100vh;">
        ...
        <div class="main_right bg_white" style="width: 100%;">
            <div class="main_right_title p_10" style="height: 50px; border-bottom: 1px solid #ccc;">
                <h2 class="font_18">법인차량운행일지</h2>
            </div>
        </div>
        <div class="main_right_info" style="padding: 30px 20px;">
            <form method="post" id="frm" name="frm" action="${pageContext.request.contextPath}/admin/corp_car_log_update">
                ...
                <div class="input_list">
                        ...
                        <tr>
                            ...
                            <td class="p_lr3">
                                <select class="sel_100" name="carKey" id="carKey">
                                    <option value="N"<c:if test="car_key=='N'">selected</c:if>>미확인</option>
                                    <option value="Y"<c:if test="car_key =='Y'">selected</c:if>>확인</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <div class=pid_area></div>
	                    <div class="btn-grp center m_t10">
		                	...
		                	<button type="button" id="back" onClick="location.href='${pageContext.request.contextPath}/admin/corp_car_log?carID=${carID}'" class="btn_red">수정취소</button>
			   		 	</div>
			   		 	</div>
			   	</form> 
                 ...
                 <strong>차량 번호</strong>를 선택하시면 해당 차량의 일지를 작성할 수 있습니다.
                    ...
                    <div class="m_b5 flex space_between">
	                        <div class="btn_wrap float_l m_b5" style="position: relative;">
	                            ...
	                            <button class="btn_blue m_r3"  onClick="location.href='${pageContext.request.contextPath}/admin/corp_car_log?carID=0'">전체일지</button>
	                            <button class="btn_write" style="position: absolute; height: 35.49px;" onClick="location.href='${pageContext.request.contextPath}/admin/corp_car_management'">차량목록</button>	                            
	                        </div>
	                        <form method="post" action="${pageContext.request.contextPath}/admin/corp_car_log">
                    ...
                    <div class="" style="width: 100%; white-space: nowrap; overflow-x: scroll;">
                        <table class="list clearfix">
                            ...
                            <tbody>
                            <c:forEach var="carUse" items="${list}">
                                <tr>
                                    <td><input type="checkbox" name="chk" class="chk"  data-uid="${carUse.carPID}"/></td>
                                    <td>${carUse.carPID}</td>
                                    <td>${carUse.carModel}</td>
                                    <td class="weight_700 under"><a href="${pageContext.request.contextPath}/admin/corp_car_log?carID=${carUse.carIDFk}">${carUse.carNum}</a></td>
                                    ...
                                    <td>
                                    <c:if test="${carUse.carKey=='N'}">미확인</c:if>
                                    <c:if test="${carUse.carKey=='Y'}">확인</c:if>
                                    </td>
