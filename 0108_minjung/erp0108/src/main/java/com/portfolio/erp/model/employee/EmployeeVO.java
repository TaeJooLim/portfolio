...
public class EmployeeVO {
   ...
   // 연차
   private double empOffTotal;			// 입사이후 생성된 연차의 갯수
   private double empOffUse;			// 입사이후 사용한 휴가의 갯수
   private double empOffRemain;			// 입사이후 남은 휴가의 갯수
   ...
   public double getEmpOffTotal() {
      return empOffTotal;
   }
   public void setEmpOffTotal(double empOffTotal) {
