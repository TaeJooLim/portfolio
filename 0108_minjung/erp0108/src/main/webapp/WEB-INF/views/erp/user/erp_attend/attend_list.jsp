                ...
                <div class="">
                    ...
                    <div class="m_t10 center">
                        <div class="page_grp center white_s_no">
                            <a href="">
                                <span class="page pg_hover" style="margin-bottom: 0"><i class="fas fa-angle-double-left"></i></span>
                            </a>
                            <a href="">
                                <span class="page pg_hover" style="margin-bottom: 0"><i class="fas fa-angle-left"></i></span>
                            </a>
                            <a href="">
                                <span class="page pg_selected " style="margin-bottom: 0">1</span>
                            </a>
                            <a href="">
                                <span class="page pg_hover" style="margin-bottom: 0">2</span>
                            </a>
                            <a href="">
                                <span class="page pg_hover" style="margin-bottom: 0"><i class="fas fa-angle-right"></i></span>
                            </a>
                            <a href="">
                                <span class="page pg_hover" style="margin-bottom: 0"><i class="fas fa-angle-double-right"></i></span>
                            </a>
                        </div>
                    </div>
                </div>
