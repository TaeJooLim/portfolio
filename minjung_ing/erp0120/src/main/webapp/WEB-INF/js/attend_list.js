	...
	function changeWorkplace(thisValue,aid,empName,attendWorkdate){
		...
		if( confirm(msg) ){
			$.ajax({
				url		: "/erp/admin/change_workplace",
				type	: "POST",
				data	: {
					attendId		: aid,
			...
			success	: function(resData){
	            ...
	            a += '<tr style="background-color:#fff;">';
	            	...
	            	a += '<td>';
	            		...
	            		a += '<input type="hidden" name="empIdFk" value="'+ resData.empIdFk +'"/>';
	            	a += '</td>';
	            a += '</tr>';
