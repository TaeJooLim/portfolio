                            ...
                            <tbody>
                                ...
                                <c:forEach items="${subjectList}" var="slist" varStatus = "status">
	                                <tr>
	                                    ...
	                                    <td><a class="under weight_700" href="${pageContext.request.contextPath}/admin/order_modify?orderDocNum=${slist.orderDocNum}">${slist.orderSubject}</a></td>
	                                    ...
	                                    <td>
	                                    	<c:choose>
	                                    		...
	                                    		<c:otherwise>
	                                    			<button type="button" class="s_btn_red">결재</button>
	                                    		</c:otherwise>
	                                    	</c:choose>
...
<script>
	var curHref = "/erp/admin/orderList";
