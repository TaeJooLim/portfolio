        ...
        <div class="page_main flex space_between">
            <div class="main_right bg_white" style="width: 100%;">
                <div class="main_right_title p_10 flex space_between" style="height: 50px; border-bottom: 1px solid #ccc;">
                    <h2 class="font_18">사용자정보관리<i class="fas fa-chevron-right p_lr10"></i>1. 내정보 관리</h2>
                    <span class="p_r10">
                ...
                <div class="main_right_info" style="padding: 30px 20px;">
                    ...
                    <div class="info_table">
                        <div class="page_content ">
                            <form id="" action="${pageContext.request.contextPath}/user/my_info" name="" method="POST" enctype="multipart/form-data">
                              <!-- 해당 사원 정보 받아오기 -->
                                ...
                                <div class="member_info flex space_between">
                                    <div class="member_left">
                                        <div class="photo_area">
                                        	<c:choose>
                                        		<c:when test="${myInfo.empPhoto eq null}">
		                                            <img src="${pageContext.request.contextPath}/images/people/user_img_default.jpg" alt="" id="empPhoto">
                                        		</c:when>
                                        		<c:otherwise>
                                        			<!-- (있으면)사진파일 -->
                                        			<img src="${pageContext.request.contextPath}/imgUpload/${myInfo.empPhoto}" alt="" id="empPhoto"/>
                                        		</c:otherwise>
                                        	</c:choose>
                                        </div>
                                        <div class="photo_btn center">
                                            <input id="empPhotoUploadBtn" type="file" class="td_100" name="file">
                                        </div>
                                    </div>
                                    <div class="member_right">
                                        <table class="input_list m_b30">
                                            <tr>
                                                <td class="td_8 center bg_gray"><span class="req"></span>소속</td>
                                                <td class="td_12 p_lr3">
                                                    <select class="sel_100" name="empCompany" onFocus="this.initialSelect = this.selectedIndex;" onChange="this.selectedIndex = this.initialSelect;" required>
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <select class="sel_100" id="empDepartment" name="empDepartment" onFocus="this.initialSelect = this.selectedIndex;" onChange="this.selectedIndex = this.initialSelect;" required>
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <select class="sel_100" name="empTeam" onFocus="this.initialSelect = this.selectedIndex;" onChange="this.selectedIndex = this.initialSelect;" required>
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <input type="date" name="empEnter" id="" class="input_100" value="${myInfo.empEnter}" readonly required/>
                                                </td>
                                                <td class="td_8 center  bg_gray weight700"><span class="req"></span>가입년월일</td>
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="" id="empRegdate" class="input_100" value="${regdate}" readonly required/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="td_8 center  bg_gray weight700"><span class="req"></span>사번</td>
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empNum" id="empNum" class="input_100" value="${myInfo.empNum }" readonly required />
                                                </td>
                                                <td class="td_8 center  bg_gray weight700"><span class="req"></span>사원명/성별</td>
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empName" id="empName" class="input_box" style="width: calc(100% - 31% - 2px);" value="${myInfo.empName }" maxlength="30" readonly required/>
                                                    <select class="input_box float_r" name="empGender" style="width: 30%;" onFocus="this.initialSelect = this.selectedIndex;" onChange="this.selectedIndex = this.initialSelect;" required>
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empCP" id="empCP" value="${myInfo.empCP}" class="input_100" maxlength="13" required/>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <select class="sel_100" id="empPosition" name="empPosition" onFocus="this.initialSelect = this.selectedIndex;" onChange="this.selectedIndex = this.initialSelect;" required>
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <select name="empDriving" class="input_100" id="empDriving">
                                                    	<option>-</option>
                                                        <option value="Y"<c:if test="${myInfo.empDriving eq 'Y'}">selected</c:if>>Y</option>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_12 p_lr3" onClick="execDaumPostcode();">
                                                    <input type="text" name="empPost" id="empPost" value="${myInfo.empPost }" class="input_100" maxlength="5" required placeholder="우편번호를 입력해주세요" readonly />
                                                </td>

                                                <td class="td_8 center  bg_gray weight700">주소</td>
                                                <td colspan="5" class="td_12 p_lr3">
                                                    <input type="text" name="empAddress" id="empAddress" class="input_100"  value="${myInfo.empAddress }" maxlength="100" readonly/>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <select name="empBank" class="sel_100" id="empBank" required >
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empAccountnum" id="empAccountnum" class="input_100"   value="${myInfo.empAccountnum }" maxlength="20" required/>
                                                </td>
                            ...
                            <div>
                                ...
                                <table class="user_table_list m_b30">
                                    ...
                                    <c:forEach items="${coworker}" var="coworker" varStatus="status">
                                        <tr>
...
<%@ include file="/WEB-INF/views/erp/user/include/USER_FOOTER.jsp" %>
			...
			<script>
				...
				$("#empPhotoUploadBtn").change(function() {
					readImage(this);
				});
			</script>