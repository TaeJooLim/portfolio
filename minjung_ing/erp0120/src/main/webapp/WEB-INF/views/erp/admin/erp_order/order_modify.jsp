                    	...
                    	<div class="reg_tbl_wrap ">
                            <table class="input_list">
                                <tr>
                                    ...
                                    <td class="td_8 bg_gray">최초작성자</td>
                                    <td class="p_lr3">
                                    ...
                                    <td class="td_8 bg_gray">최초작성일자</td>
                                    <td class="p_lr3">
                                        <input type="text" id="orderDate" name="orderDate" class="input_100" value="${firstOrderList.orderDate}" readonly/>
                                    </td>
                                </tr>
                                <tr>
