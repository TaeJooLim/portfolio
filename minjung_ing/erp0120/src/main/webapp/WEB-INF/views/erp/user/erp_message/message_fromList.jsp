...
<body>
                    ...
                    <div class="right_top">
                        <div class="right_top_btn flex" style="line-height: 30px;">
                        	...
                        	<a href="${pageContext.request.contextPath}/user/message_fromList?empId=${sessionScope.empId}">
	                            <div class="total_list_btn m_r5" style="background-color: #148cb2;">받은 쪽지</div>
                        	</a>
                        ...
                        <div class="flex m_tb10">
                			<div>
                                <button class="rad_btn_blue white_s_no" id="delFromMsgAll">선택삭제</button>
                            </div>
    ...
    <script src="${pageContext.request.contextPath}/js/common.js"></script>
        <script>
			var curHref = "/erp/user/message_fromList?empId=${sessionScope.empId}";
