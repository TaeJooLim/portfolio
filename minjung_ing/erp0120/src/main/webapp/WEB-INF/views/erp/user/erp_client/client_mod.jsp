	            ...
	            <div class="main_right_info" style="padding: 30px 20px;">
	                ...
	                <input type="hidden" value="${clientId}"/>
	                    ...
	                    <div class="btn-grp center m_tb30">
	                        <button type="submit" class="btn_blue" style="background-color: #00136f;" >저장</button>
	                        <button type="reset" class="btn_red">새로고침</button>
	                        <button type="button" class="btn_ivory" style="background-color: #148cb2;" onClick="location.href='${pageContext.request.contextPath}/user/client_list'">목록으로</button>
	                    </div>
	                </form>
	            </div>
	        </div>
