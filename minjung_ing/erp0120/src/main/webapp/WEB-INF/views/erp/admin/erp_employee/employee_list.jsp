        ...
        <div class="page_main flex space_between">
            <div class="main_right bg_white" style="width: 100%;">
                <div class="main_right_title p_10" style="height: 50px; border-bottom: 1px solid #ccc;">
                    <h2 class="font_18">인사/급여관리<i class="fas fa-chevron-right p_lr10"></i>1. 사원목록</h2>
                </div>
                <div class="main_right_info" style="padding: 30px 20px;">
                    <div class="right_top">
                        ...
                        <div class="flex m_tb10">
                            ...
                            <div class="list_comment font_14" style="width:100%; padding: 10px 20px; background-color: #f9f9f9;">
