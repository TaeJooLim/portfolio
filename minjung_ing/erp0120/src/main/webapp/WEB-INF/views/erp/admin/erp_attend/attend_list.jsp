    ...
    <div class="page_wrap bg_white noto font_14">
        ...
        <div class="main_right bg_white" style="width: 100%;">
            <div class="main_right_title p_10" style="height: 50px; border-bottom: 1px solid #ccc;">
                <h2 class="font_18">근태관리<i class="fas fa-chevron-right p_lr10"></i>1. 출퇴근현황</h2>
            </div>
        </div>

        <div class="main_right_info" style="padding: 10px 20px;">
	        <div class="list_title p_tb10">
         	...
         	<div class="m_b10 flex space_between" style="align-items:flex-end;">
         		<div>
        			<button type="button" class="rad_btn_red" onclick="deleteRecords();">선택삭제</button>
         		</div>
            	<div class="search_wrap">
	                <div class="flex space_between">
		                ...
		                <form method="POST" action="${pageContext.request.contextPath}/admin/attend_list" >
			                <div class="search_grp flex">
			                	<select class="search_sel_box" style="height:30px;" id="searchOpt" name="searchOpt" onchange="changeInputBox(this.value);">
			                    	...
			                    	<option value="attend_status">상태</option>
	              ...
	              <div class="w_100 white_s_no overflow_x_auto m_b10">
	                ...
	                <c:forEach items="${list}" var="list" varStatus="status">
		                <tr>
		                	<td><input type="checkbox" name="chk" class="chk" data-uid="${list.attendId}"/></td>
...
<script src="${pageContext.request.contextPath}/js/attend_list.js"></script>
<script>
	var curHref = "/erp/admin/attend_list";
