	                        ...
	                        <tr>
	                            ...
	                            <td class="p_lr10 td_80">
		                           	<div class="search_btn_grp w_100">                    	
		        						<form class="flex space_between flex_vc w_100" method="post" name="" action="${pageContext.request.contextPath}/user/empNameSearch">
...
function msgSend() {
	...
	$.ajax({
		...
		success : function(resData) {
					...
					opener.document.location.href="${pageContext.request.contextPath}/user/message_sendList?empId=${sessionScope.empId}";
					self.close();
		},
		error 	: function() {
