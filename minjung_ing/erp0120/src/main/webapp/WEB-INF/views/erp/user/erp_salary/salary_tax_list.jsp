    ...
    <div class="page_wrap bg_white noto font_14">
            <div class="main_right bg_white">
                <div class="main_right_title p_10" style="height: 50px; border-bottom: 1px solid #ccc;">
                    <h2 class="font_18">인사/급여관리<i class="fas fa-chevron-right p_lr10"></i>4. 세금계산테이블수정</h2>
                </div>
                <div class="main_right_info" style="padding: 30px 20px;">
        			<div class="table_wrap_box">
                    <div class="right_top">
                        <div class="employee_count_btn_grp flex">
                            <button class="font_14 left_radius_btn white">기준년도</button>
                            <button class="font_14 right_radius_btn">2020년</button>
                        </div>
                            ...
                            <c:forEach items="${list}" var="list" varStatus="status">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" id="delBtn" onClick="deleteSalaryTax(${list.salaryId},${list.salaryNps});" class="delBtn_${list.salaryId} s_btn_red">삭제</button>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody> 
...
<script>
	function fn_paging(curPage) {
		var curHref = "/erp/user/salary_tax_list";
		var searchTXT = "?curPage=";
