...
<c:if test="${sessionScope.empDepartment ne '200' && sessionScope.empDepartment ne '700' && sessionScope.empAuth ne 10}">
	<script>
		alert("경영과 및 영업과 외의 사용자는 접근할 수 없는 페이지입니다.\n관리자에게 문의하세요.");
		history.go(-1);
	</script>
</c:if>
<body>
	    ...
	    <div class="page_main flex space_between">
	        <div class="main_right bg_white" style="width: 100%;">
	            ...
	            <div class="main_right_info" style="padding: 30px 20px;">
	                ...
	                <form id="frm" method="POST" action="${pageContext.request.contextPath}/user/client_reg">
	                    <div class="table_grp flex space_between">
	                        <div class="left_tbl_grp m_r10" style="width: 25%;">
	                            <table>
	                                ...
	                                <tr>
	                                	<td class="p_lr3 center" colspan="2">
	                                    	<span class="">거래처 코드는 등록 완료 후<br/>자동으로 생성됩니다.</span>
	                                    </td>
	                                </tr>
	                                <tr>
	                    ...
	                    <div class="btn-grp center m_tb30">
	                        <button type="submit" class="btn_blue" tabindex="23">거래처등록</button>
	                        <button type="reset" class="btn_red" tabindex="24">새로고침</button>
	                        <button type="button" class="btn_ivory" onClick="location.href='${pageContext.request.contextPath}/user/client_list'">목록으로</button>
	                    </div>
	                </form>
	            </div>
	        </div>
