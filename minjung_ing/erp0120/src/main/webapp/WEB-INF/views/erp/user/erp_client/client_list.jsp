        ...
        <div class="table_wrap_box">
            <div class="search_wrap m_b10">
            	<div class="total_cnt_btn_grp flex">
            		<button type="button" class="total_list_btn m_r5" onClick="window.location.href='${pageContext.request.contextPath}/user/client_list'">전체목록</button>
            	...
            	<table class="user_table_list">
            		<thead>
            			<tr>
                            ...
                            <th>종목</th>
                            <th>비고</th>
                            <c:if test="${sessionScope.empDepartment eq '200' || sessionScope.empAuth eq 10}">
								<th>관리</th>
							</c:if>
					</tr>
                   	</thead>
                   	<c:forEach items="${list}" var="list" varStatus="status">
                        ...
                        <tbody>
                            <tr>
	                            ...
	                            <c:if test="${sessionScope.empDepartment eq '200' || sessionScope.empAuth eq 10}">
		                            <td>
		                            	<button type="button" onClick="location.href='${pageContext.request.contextPath}/user/client_mod?clientId=${list.clientId}'" class="s_btn_blue">수정</button>
