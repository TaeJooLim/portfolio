...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/button_style.css">
	...
	<div class="page_wrap bg_white noto font_14">
        ...
        <div class="main_right_info" style="padding: 30px 20px;">
            <div class="search_wrap">
	            	<div class="total_cnt_btn_grp flex">
	            		<c:choose>
	            			<c:when test="${appType eq 'V'}">
	            				<a href="${pageContext.request.contextPath}/admin/appWaiting?empId=${sessionScope.empId}&appType=O">
	                        		<div class="total_list_btn m_r5" style="background-color: #d6dcec;">구매요청서</div>
                        		</a>
			            		<a href="${pageContext.request.contextPath}/admin/appWaiting?empId=${sessionScope.empId}">
	                ...
	                <form id="" name="" method="post" action="${pageContext.request.contextPath}/admin/appWaiting?appType=${appType}&empId=${sessionScope.empId}">
	...
	<script>
		var curHref = "/erp/admin/appwaiting?empId=${sessionScope.empId}";
