	...
	<div class="page_wrap bg_white noto font_14">
        ...
        <div class="main_right bg_white" style="width: 100%;">
            <div class="main_right_title p_10" style="height: 50px; border-bottom: 1px solid #ccc;">
                <h2 class="font_18">전자결재관리<i class="fas fa-chevron-right p_lr10"></i>3. 상신함</h2>
            </div>
        </div>
        <div class="main_right_info" style="padding: 30px 20px;">
            <div class="search_wrap">
	            	<div class="total_cnt_btn_grp flex">
	            		<c:choose>
	            			<c:when test="${appType eq 'V'}">
	            				<a href="${pageContext.request.contextPath}/admin/appSend?empId=${sessionScope.empId}&appType=O">
	                        		<div class="total_list_btn m_r5" style="background-color: #d6dcec;">구매요청서</div>
                        		</a>
			            		<a href="${pageContext.request.contextPath}/admin/appSend?empId=${sessionScope.empId}">
	                ...
	                <form id="" name="" method="post" action="${pageContext.request.contextPath}/admin/appSend?appType=${appType}&empId=${sessionScope.empId}">
