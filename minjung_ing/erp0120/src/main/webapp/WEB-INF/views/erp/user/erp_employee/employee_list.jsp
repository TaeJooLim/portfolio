...
<!-- 읽기 권한 처리 -->
<c:if test="${sessionScope.empAuth ne 10 && sessionScope.empDepartment ne '100'}">
	<script>
        ...
        <div class="page_main flex space_between">
            <div class="main_right bg_white" style="width: 100%;">
                <div class="main_right_title p_10" style="height: 50px; border-bottom: 1px solid #ccc;">
                    <h2 class="font_18">인사/급여관리<i class="fas fa-chevron-right p_lr10"></i>1. 사원목록보기</h2>
                </div>
                <div class="main_right_info" style="padding: 30px 20px;">
                    ...
                    <div class="right_top">
                        <div class="search_wrap">
                            <div class="total_cnt_btn_grp flex">
                                ...
                                <div class="search_cnt_btn_grp flex">
                                    <div class="left_radius_btn white" style="line-height: 30px;">검색된 사원 수</div>
                                    <div class="right_radius_btn" style="line-height: 30px;">${listCnt}명</div>
                                </div>
                            </div>
                            <form id="" name="" action="">
                        ...
                        <div class="flex m_tb10">
                            ...
                            <div class="list_comment font_14 p_lr10 p_tb5" style="width:96%;height:32px;background-color: #f9f9f9;">
                                    ...
                                    <c:forEach items="${list}" var="emp" varStatus="status">
                                        <tr>
                                            ...
                                            <td rowspan="2">
                                                ...
                                                <button class="s_btn_red" onClick="deleteOne(${emp.empId});">삭제</button>
                                            </td>
                                        </tr>
                                        <tr>
