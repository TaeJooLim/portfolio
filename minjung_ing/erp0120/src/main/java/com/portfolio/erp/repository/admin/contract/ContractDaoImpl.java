...
public class ContractDaoImpl implements ContractDao{
	...
	public int getContID() {
		return sqlSession.selectOne("contract.getContID");
	}
	...
	public void setContDel(int contID) {
		String contD_doc_num_fk = sqlSession.selectOne("contract.getcontDocNum", contID);
		HashMap<String, String> map = new HashMap<String, String>();
		map.put("contDocNum", contD_doc_num_fk);
		
		sqlSession.delete("contract.delContractDetail", map);
		sqlSession.delete("contract.setContDel",contID);
		sqlSession.delete("produce.delProduceOne", map);
	}
	...
	public int countC(String words,String searchOpt) {
		...
		map.put("searchOpt", searchOpt);
		map.put("words", words);
		return sqlSession.selectOne("contract.countC",map);
	}
