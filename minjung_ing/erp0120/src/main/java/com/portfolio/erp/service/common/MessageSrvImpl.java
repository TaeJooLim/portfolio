...
public class MessageSrvImpl implements MessageSrv {
	...
	@Override
	public List<MessageVO> getSendMessageList(int empId, String searchOpt, String words, int startIndex, int pageSize) {
		return messageDao.getSendMessageList(empId, searchOpt, words, startIndex, pageSize);
	}

	@Override
	public List<MessageVO> getFromMessageList(int empId, String searchOpt, String words, int startIndex, int pageSize) {
		return messageDao.getFromMessageList(empId, searchOpt, words, startIndex, pageSize);
	}
