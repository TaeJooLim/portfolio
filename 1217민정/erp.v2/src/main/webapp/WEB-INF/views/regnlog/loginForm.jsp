...
<body>
<input type="text" id="chkMsg" value="${msg}" />
            ...
            <div class="login_box p_30 center flex flex_hc flex_vc">
	            <div>
	                ...
	                <form id="" name="logFrm" method="POST" action="${pageContext.request.contextPath}/login">
	                    ...
	                    <button type="submit" id="btn" class="login_btn m_tb20 bg_blue_1 white font_16">로그인</button>
	                </form>
	                ...
	                <div class="m_t20">
	                    ...
	                    <span class="font_14"><a class="blue_1" href="registerForm.html">지금  회원가입하세요</a></span>
	                </div>
	            </div>
            </div>
        </div>
