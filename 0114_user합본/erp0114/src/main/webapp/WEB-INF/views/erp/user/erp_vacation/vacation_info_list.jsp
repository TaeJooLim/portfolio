...
<c:if test="${sessionScope.empDepartment != 100 && sessionScope.empNum ne 'admin'}">
	<script>
		alert("인사과 외의 사용자는 접근할 수 없는 페이지입니다.\n관리자에게 문의하세요.");
		window.location.replace("${pageContext.request.contextPath}/user_main");
	</script>
</c:if>
    ...
    <div class="page_wrap bg_white noto font_14">
        ...
        <div class="main_right bg_white" style="width: 100%;">
            <div class="main_right_title p_10" style="height: 50px; border-bottom: 1px solid #ccc;">
                <h2 class="font_18">근태관리<i class="fas fa-chevron-right p_lr10"></i>3. 휴가사용이력조회</h2>
            </div>
        </div>
