                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${mList}" var="mlist">
                                        <tr>
                                            ...
                                            <td class="left p_l10">
	                                            <a target="_blank" href="${pageContext.request.contextPath}/user/message_read?msgId=${mlist.msgId}&typeChk=0" <c:if test="${mlist.msgConfirm eq 'N'}">class="weight_700"</c:if>>
	                                            	${mlist.msgSubject}
	                                            </a>
	                                        </td>
