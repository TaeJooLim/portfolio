...
public class CommonDaoImpl implements CommonDao {
	...
	@Override
	public String getDepartmentOne(String empDepartment) {
		return sqlSession.selectOne("common.getDepartmentOne", empDepartment);
	}

	@Override
	public EmployeeVO getDepartmentCode(EmployeeVO evo) {
		return sqlSession.selectOne("common.getDepartmentCode", evo);
	}
