...
public class ContractVO {
	...
	private int pIdFk;			// 제품정보 PK를 FK로 저장하여 조인
	private int pBuy;
	private String pSize;
	private String pCode;
	
	private int ref; // cont_doc_num 중복방지 자동계산
	private String clientCom; //client조인 거래처이
	...
	public String getContClientCode() {
		return contClientCode;
	}
	public void setContClientCode(String contClientCode) {
		this.contClientCode = contClientCode;
	}
