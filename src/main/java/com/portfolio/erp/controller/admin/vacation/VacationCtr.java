...
public class VacationCtr {
	...
	@ResponseBody
	public String deleteVacation(@RequestParam String offStartDate, 
								 @RequestParam String offEndDate, 
		...
		/*employee table 연차 정보 업데이트*/
		double offUse = empOffUse - offDateCnt;
		evo.setEmpOffUse(offUse);
		...
		vcSrv.deleteVacation(offStartDate, offEndDate, empId);
		return "success";
	}
