        ...
        <div class="page_main flex space_between" style="border-bottom: 1px solid #ccc;">
            <div class="main_right bg_white" style="width: 100%;">
                <div class="main_right_title p_10" style="height: 50px; border-bottom: 1px solid #ccc;">
                    <h2 class="font_18">회사기초정보입력</h2>
                </div>
                <div class="main_right_info" style="padding: 30px 20px;">
                    <div class="">
                        <form id="companyFrm" method="POST" action="${pageContext.request.contextPath}/admin/company">
                            <div class="table_title">
                                <i class="fas fa-edit"></i>회사정보등록
                            </div>
                            <table class="input_list m_b10">
                                ...
                                <tr>
                                    ...
                                    <td class="p_lr3" onClick="execDaumPostcode();">
                                        <input type="text" name="comPost" maxlength="15" id="empPost" value="${company.comPost}" class="input_100" autoComplete="off" required />
                                    </td>
                                    <td class="bg_gray weight_700 td_10 center">주소</td>
                                    <td class="p_lr3" colspan="3">
                                        <input type="text" name="comAddress" id="empAddress" value="${company.comAddress}" maxlength="100" class="input_100" autoComplete="off" required placeholder="주소를 입력해주세요" />
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="p_5">
                                        ...
                                        <div class="photo_btn center m_t5">
                                            <input type="file" name="comCeoImg" id="comCeoImg" class="input_100" />
                                        </div>
                                    </td>
                                    <td class="p_5">
                                        <div class="photo_area">
                                        ...
                                        <div class="photo_btn center m_t5">
                                            <input type="file" name="comStampImg" id="comStampImg" class="input_100" />
                                        </div>
                                    </td>
                                    <td class="p_5">
                                        <div class="photo_area">
                                            <img src="${pageContext.request.contextPath}/images/no.jpg" id=" " />
                                        </div>
                                        <div class="photo_btn center m_t5">
                                            <input type="file" name="comCeoStampImg" id="comCeoStampImg" class="input_100" />
                                        </div>
                                    </td>
                                    <td class="p_5">
                                        <div class="photo_area">
                                        ...
                                        <div class="photo_btn center m_t5">
                                            <input type="file" name="comCeoSignImg" id="comCeoSignImg" class="input_100" />
                                        </div>
                                    </td>
                                </tr>
                            </table>
