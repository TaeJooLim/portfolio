        ...
        <div class="page_main flex space_between" style="border-bottom: 1px solid #ccc;">
            <div class="main_right bg_white" style="width: 100%;">
                <div class="main_right_title p_10" style="height: 50px; border-bottom: 1px solid #ccc;">
                    <h2 class="font_18">인사급여관리<i class="fas fa-chevron-right p_lr10"></i>3. 사원목록보기</h2>
                </div>
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${list}" var="emp" varStatus="status">
                                        ...
                                        <tr>
                                            ...
                                            <td>${emp.empGender}</td>
                                            <td>
                                            	<select class="sel_100" name="empAuth" id="empAuth" onChange="authChange(this.value, '${emp.empId}');" style="height:20px;">
