            ...
            <nav class="flex">
                ...
                <div id="sub_menu" class="">
                    ...
                    <ul id="attendMngmt" class="menu">
                        ...
                        <li><a href="${pageContext.request.contextPath}/admin/vacation?empId=${sessionScope.empId}">휴가사용신청(X)</a></li>
                    </ul>
                    ...
                    <ul id="boardMngmt" class="menu">
                        <h3>게시판관리</h3>
                        <li><a href="${pageContext.request.contextPath}/admin/board_list">게시판목록</a></li>
                        <li><a href="${pageContext.request.contextPath}/admin/board_reg">게시판생성 및 관리(X)</a></li>
                        <li><a href="${pageContext.request.contextPath}/admin/board_view">게시글 상세보기(X)</a></li>
                        <li><a href="${pageContext.request.contextPath}/admin/board_write">게시글 작성하기(X)</a></li>
                    </ul>
