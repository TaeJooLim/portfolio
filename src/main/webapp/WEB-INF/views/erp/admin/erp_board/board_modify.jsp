                            ...
                            <table class="input_list">
                                <tr>
                                    ...
                                    <td class="p_lr3 td_25">
                                        <input type="text" name="" id="" class="input_100" readonly value="${sessionScope.empDepartmentName}"/>
                                    </td>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td colspan="5" class="p_lr3">
                                        <input type="text" name="subject" id="subject" class="input_100 noto" autofocus value="${avo.subject}">
                                    </td>
                                </tr>
                                <tr>
                                 ...
                                 <td colspan="3" class="td-90 p-lr3" style="padding-top: 2px; padding-bottom: 2px;">
										<textarea name="content" id="editor" style="width: 100%; height: 300px; border: 1px solid #ccc; padding: 10px; border-radius: 2px;"
											class="noto">${avo.content}</textarea> 
											<script>
