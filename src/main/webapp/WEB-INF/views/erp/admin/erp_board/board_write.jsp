                ...
                <div class="main_right_info flex p_10">
                    ...
                    <div class="board_right">
                        <div class="board_right_info">
                         ...
                         <form id="articleForm" name="articleForm" action="${pageContext.request.contextPath}/admin/board_write_reg">
                       		<div class="">
                            <table class="input_list">
                                <tr>
                                    ...
                                    <td class="p_lr3 td_25">
                                        <input type="text" name="" id="" class="input_100" readonly required value="${sessionScope.empDepartmentName}"/>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="p_lr3">
                                        <input type="text" name="writer" id="writer" class="input_100" readonly required value="${sessionScope.empName}"/>
                                    </td>
                                 ...
                                 <tr>
                                    ...
                                    <td colspan="5" class="p_lr3">
                                        <input type="text" name="subject" id="subject" class="input_100 noto" autofocus required>
