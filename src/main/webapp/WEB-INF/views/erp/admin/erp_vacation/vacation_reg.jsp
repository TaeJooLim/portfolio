                        ...
                        <table class="emp_info_tbl">
                            ...
                            <c:forEach items="${vacationList}" var="vc">
                            	<tr>
	                                ...
	                                <td>${vc.offRegdate}</td>
	                                <td>
	                                	<c:if test="${vc.offConfirm eq 'N'}">
	                                		<button class="s_btn_gray" onClick="deleteOne('${vc.offStartDate}','${vc.offEndDate}', ${vc.offDateCnt});">취소</button>
	                                	</c:if>
	                                	<c:if test="${vc.offConfirm eq 'Y'}">
	                                		<button class="s_btn_gray" disabled>취소</button>
	                                	</c:if>
	                                </td>
                            	</tr>
                            </c:forEach>
