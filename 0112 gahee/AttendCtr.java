...
public class AttendCtr {
	...
	public Map<String, Object> getRecordOne(@ModelAttribute AttendVO avo) {
		...
		map.put("empIdFk", attend.getEmpIdFk());
	...
	// 외근/출장 신청서
	@RequestMapping("admin/business_trip_form")
	public ModelAndView getBusinessTripForm() {
		ModelAndView mav = new ModelAndView();
		/* 현재날짜 */
		Date now = new Date();
		...
		mav.setViewName("/erp/admin/erp_attend/business_trip_form");
