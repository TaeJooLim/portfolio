                    ...
                    <div>
                        <h1 class="p_b30">회원가입</h1>
                        	<div class="login_input_grp">
	                            ...
	                            <input type="date" max="2020_12_31" min="1970_01_01" class="login_box_input p_l10 noto font_16 weight_500 m_b10" id="empEnter" name="empEnter" data-placeholder="입사년도, 월, 일을 입력해주세요." tabindex="3" required />
	                            ...
	                            <input type="text" class="login_box_input p_l10 noto font_16 weight_500 m_t10" id="empName" name="empName" placeholder="사원명을 입력해주세요." tabindex="5" required />
	                            <input type="text" class="login_box_input p_l10 noto font_16 weight_500 m_t10" id="empEmail" name="empEmail" placeholder="이메일 주소를 입력해주세요." tabindex="6" required />
