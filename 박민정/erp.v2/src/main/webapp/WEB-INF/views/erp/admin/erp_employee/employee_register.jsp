        ...
        <div class="page_main flex space_between" style="border-bottom: 1px solid #ccc;">
            <div class="main_right bg_white" style="width: 100%;">
                <div class="main_right_title p_10" style="height: 50px; border-bottom: 1px solid #ccc;">
                    <h2 class="font_18">사원상세정보 입력/수정</h2>
                </div>
                                    ...
                                    <div class="member_right">
                                        <table class="input_list">
                                            <tr>
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empEnter" id="" class="input_100" autofocus value="${employee.empEnter }"   />
                                                </td>
                                                <td class="td_8 center  bg_gray weight700"><span class="req"></span>가입년월일</td>
                                                <td class="td_12 p_lr3">

                                                    <input type="text" name="" id="empRegdate" class="input_100" value="${employee.empRegdate }" readonly placeholder="자동입력" autofocus  />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="td_8 center  bg_gray weight700"><span class="req"></span>사번</td>
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empNum" id="empNum" class="input_100" value="${employee.empNum }" readonly autofocus placeholder="자동입력" />
                                                </td>
                                                <td class="td_8 center  bg_gray weight700"><span class="req"></span>사원명/성별</td>
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empName" id="empName" class="input_box" style="width: calc(100% - 31% - 2px);" value="${employee.empName }"  autofocus />
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empBirth" id="empBirth" class="input_100" value="${employee.empBirth }" />

                                                </td>
                                                <td class="td_8 center  bg_gray weight700"><span class="req"></span>CP</td>
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empCP" id="empCP" value="${employee.empCP }" class="input_100" />
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empMajor" id="empMajor" value="${employee.empMajor }" class="input_100" autofocus maxlength="20" />
                                                </td>
                                                <td class="td_8 center  bg_gray weight700">학교이름</td>
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empAcademy" id="empAcademy" class="input_100" value="${employee.empAcademy }" autofocus />
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_12 p_lr3" colspan="3">
                                                    <input type="text" name="empEmail" id="empEmail" class="input_100" value="${employee.empEmail}"  autofocus />
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_12 p_lr3"> <input type="text" name="empLicense1" id="empLicense1" class="input_100" value="${employee.empLicense1 }" autofocus /></td>
                                                <td class="td_8 center  bg_gray weight700">보유자격 2</td>
                                                <td class="td_12 p_lr3"> <input type="text" name="empLicense2" id="empLicense2" class="input_100" value="${employee.empLicense2 }" autofocus /></td>
                                                <td class="td_8 center  bg_gray weight700">보유자격 3</td>
                                                <td class="td_12 p_lr3"> <input type="text" name="empLicense3" id="empLicense3" class="input_100" value="${employee.empLicense3 }" autofocus /></td>
                                                <td class="td_8 center  bg_gray weight700">어학자격 1</td>
                                                <td class="td_12 p_lr3"> <input type="text" name="empLang1" id="empLang1" class="input_100" value="${employee.empLang1 }" autofocus /></td>
                                                <td class="td_8 center  bg_gray weight700">어학자격 2</td>
                                                <td class="td_12 p_lr3"> <input type="text" name="empLang2" id="empLang2" class="input_100" value="${employee.empLang2 }" autofocus /></td>
                                            </tr>
                                            <tr>

                                                <td class="td_8 center  bg_gray weight700">국적</td>
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empNation" id="empNation" value="${employee.empNation }" class="input_100" autofocus />

                                                </td>
                                                <td class="td_8 center  bg_gray weight700">우편번호</td>
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empPost" id="empPost" value="${employee.empPost }" class="input_100" autofocus />
                                                </td>

                                                <td class="td_8 center  bg_gray weight700">주소</td>
                                                <td colspan="5" class="td_12 p_lr3">
                                                    <input type="text" name="empAddress" id="empAddress" class="input_100"  value="${employee.empAddress }" autofocus />
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_12 p_lr3">
                                                    <input type="text" name="empAccountnum" id="empAccountnum" class="input_100" autofocus value="${employee.empAccountnum }"   />
                                                </td>
                                                <td class="td_8 center  bg_gray weight700">상세주소</td>
                                                <td colspan="5" class="td_12 p_lr3">
                                                    <input type="text" name="empAddressDetail" id="empAddressDetail" class="input_100" value="${employee.empAddressDetail }" autofocus />
                                                </td>
                                            </tr>
                                        </table>
