	...
	<div class="main_right bg_white" style="width: 100%;">
                ...
                <div class="main_right_info flex p_10">
                    ...
                    <div class="board_right">
                        ...
                        <div class="flex space_between" style="align-items:flex-end;">
                            <div class="flex" style="white-space: nowrap;">
	                            <c:if test="${sessionScope.empAuth eq 10}">
	                                <button class="rad_btn_blue m_r10" id="deleteAll" onclick="deleteAll('${bvo.boardNum}');" >선택삭제</button>
	                            </c:if>
                                <div class="font_14" style="padding-top: 13px;  color: #4c4c4c;"> 전체 게시물 / <strong>${listCnt}</strong>개 </div>
                            </div>
	                        <form method="post" action="${pageContext.request.contextPath}/user/board_list?boardNum=${bvo.boardNum}">
                        ...
                        <div class="w_100 white_s_no overflow_x_auto m_t10 m_b30">
                            <table class="user_table_list">
                                        ...
                                        <td>
                                        	<c:choose>
	                                        	<c:when test="${sessionScope.empAuth eq 10 || sessionScope.empId eq alist.empIdFk}">
	                                        		<button class="total_list_btn" type="button" onclick="location.href='${pageContext.request.contextPath}/user/board_modify?boardNum=${bvo.boardNum}&aId=${alist.aId}'">수정</button>
	                                       		</c:when>
	                                       		<c:otherwise>
	                                       			-
	                                       		</c:otherwise>
                                ...
                                <c:if test="${empty alist}">
                                	<tfoot>
						               <tr>
						                   <td class="weight_700" colspan="10" style="height: 100px">등록된 게시글이 없습니다.</td>
						               </tr>
					            	</tfoot>
                           		</c:if>
                            </table>
