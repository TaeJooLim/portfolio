...
<!-- 읽기 권한 처리 -->
<c:if
	test="${sessionScope.empAuth ne 10 && sessionScope.empDepartment ne '500'}">
	<script>
		alert("전산과 전용입니다.\n관리자에게 문의하세요.");
		history.go(-1);
	</script>
...
<div class="page_wrap bg_white noto font_14" >
	<div class="main_right bg_white" style="width: 100%;" >
                <div class="main_right_title p_10" style="height: 50px; border-bottom: 1px solid #ccc;">
                    <h2 class="font_18">게시판관리<i class="fas fa-chevron-right p_lr10"></i>2. 게시판관리</h2>
                </div>
                <div class="main_right_info " style="padding: 30px 20px;">
                    <div class="">
                        ...
                        <div class="board_maker">
                            <form method="post" name="boardForm" id="boardForm">
                                <table class="input_list">
                                    <tr class="center">
                                        ...
                                        <td class="td_15 p_lr3">
                                            <input onblur="chkBoard();" name="boardCode" id="boardCode" type="text" class="input_100" placeholder="영어로 입력" maxlength="20"/>
                                        </td>
                                ...
                                <div class="btn_grp center m_t10">
                                	<button class="btn_blue" style="background-color: #0099a4;" type="button" id="boardUpdateBtn">게시판수정</button>
                                    <button class="btn_blue" style="background-color: #0099a4;" type="button" id="boardRegbtn">게시판생성</button>
                        ...
                        <div class="flex space_between m_b10">
                            ...
                            <div class="">
                            	<button class="btn_blue" style="background-color: #0099a4;" id="boardUp">선택수정</button>
			                                		...
			                                		<c:forEach items="${blist}" var="blist">
				                                    	<c:if test="${blist.boardDepartment eq dlist.empDepartment}">
				                                    		<div class="board_nameOne">
					                                       	...
					                                       	<span>
						                                       	<a href="${pageContext.request.contextPath}/user/board_list?boardNum=${blist.boardNum}">${blist.boardName}</a>
...
function boardReg() {
	...
	$.ajax({
		...
		success	: function(resData) {
			...
			window.location.href = 	"${pageContext.request.contextPath}/user/board_reg";
		},
		error	:function() {
			alert("시스템 에러");			
		}
...
$("#deleteAll").click(function() {
    ...
    if( str ) {
        ...
        $(".chk:checked").each(function () {
            if($(this).attr("data-uid") == 1 || $(this).attr("data-uid") == 2){
					alert("사내 공지사항과 시스템 공지사항 게시판은 삭제할 수 없습니다. ");
                }else{
