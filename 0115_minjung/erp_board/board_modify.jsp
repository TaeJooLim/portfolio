        ...
        <div class="main_right_info flex p_10">
            ...
            <div class="board_right">
                <div class="board_right_info">
                 ...
                 <form id="articleForm" name="articleForm" action="${pageContext.request.contextPath}/user/board_modify_update">
               		<div class="">
                    <table class="input_list">
						...
						<tr>
	                        ...
	                        <td colspan="5" class="p_lr15 font_18" style="text-align:left;">
                ...
                <div class="flex space_between m_t10">
                    ...
                    <div class="">
                        <button class="btn_blue" style="background-color: #148cb2;" type="reset" id="reset">새로고침</button>
                        <button class="btn_red" style="background-color: #00136f;" type="submit" id="articleModifyBtn" >수정</button>
                    </div>
                </div>
                </form>
           </div>
