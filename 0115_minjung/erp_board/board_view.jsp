                        ...
                        <div class="flex space_between m_b10">
                            <div class="">
	                            <c:if test="${sessionScope.empAuth eq 10 || sessionScope.empId eq avo.empIdFk}">
	                                <button class="btn_blue" style="background-color: #148cb2;" onclick="location.href='${pageContext.request.contextPath}/user/board_modify?boardNum=${bvo.boardNum}&aId=${avo.aId}'">수정</button>
	                                <button class="btn_red" style="background-color: #00136f;" id="articleOneDelBtn" onclick="articleOneDelBtn('${bvo.boardNum}','${avo.aId}');">삭제</button>
	                            </c:if>
                            </div>
                            <div class="">
                                <button class="btn_blue" style="background-color: #0099a4;" type="button" onClick="location.href='${pageContext.request.contextPath}/user/board_list?boardNum=${boardNum}'">목록</button>
                            </div>
                        </div>
                        <div class="">
	                                    ...
	                                    <div class="flex space_between">
		                                    ...
		                                    <div class="p_r10" >
	                                            <c:if test="${sessionScope.empAuth eq 10 || sessionScope.empId eq clist.reEmpIdFk}">
		                                            <button onClick="changeComment('${clist.cId}','${clist.who}','${clist.comment}','${clist.aIdFk}');" id="changeComment">수정</button> &nbsp; 
		                                            <a href="${pageContext.request.contextPath}/user/board_comment_delete?boardNum=${boardNum}&aIdFk=${clist.aIdFk}&cId=${clist.cId}">
		                                            	<button onClick="return commentDel();">삭제</button> &nbsp;
		                                            </a> 
	                                        	</c:if>
