	...
	<div class="main_right bg_white" style="width: 100%;">
        ...
        <div class="main_right_info flex p_10">
            ...
            <div class="board_right">
                ...
                <form id="articleForm" name="articleForm" action="${pageContext.request.contextPath}/user/board_write_reg" enctype="multipart/form-data" method="POST">
               		<div class="">
                    	<table class="input_list">
							...
							<tr>
		                        ...
		                        <td colspan="5" class="p_lr5 font_18" >
		                            <input type="file" name="files" id="files" class="input_100"/>
		                        </td>
                         	</tr>
                    	</table>
                	</div>
	                ...
	                <div class="flex space_between m_t10">
	                    ...
	                    <div class="">
	                        <button class="btn_blue" style="background-color: #148cb2;" type="reset" id="reset" onClick="window.location.reload()">새로고침</button>
	                        <button class="btn_red" style="background-color: #00136f;" type="submit" id="articleRegBtn" >등록</button>
	                    </div>
	                </div>
                 </form>
            </div>
