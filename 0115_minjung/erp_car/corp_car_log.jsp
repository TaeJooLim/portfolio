                ...
                <div class="input_list">
                    ...
                    <div class=pid_area></div>
	                    <div class="btn-grp center m_t10">
	                    	<button type="button" id="carUsechangebtn" name="carUsechangebtn" class="btn_blue" style="background-color: #0099a4;">일지수정</button>
	                        <button type="button" id="carRegUseBtn" class="btn_blue" style="background-color: #0099a4;" onClick="setCarUse('${carID}')">일지등록</button>
	                        <button type="reset" id="cancel" class="btn_ivory">취소</button>	                    
		                	<button type="button" id="back" onClick="location.href='${pageContext.request.contextPath}/user/corp_car_log?carID=${carID}'" class="btn_ivory" >수정취소</button>
			   		 	</div>
			   		 	</div>
			   	</form> 
                ...
                <div class="w_100 white_s_no">
                 ...
                 <strong>차량 번호</strong>를 선택하시면 해당 차량의 일지를 작성할 수 있습니다.
                    ...
                    <div class="m_b10 flex space_between" style="align-items:flex-end;">
                        <div class="btn_wrap float_l" style="position: relative;">
                            <button class="btn_red" style="background-color: #00136f;" id="deleteAll">선택삭제</button>
                            <button class="btn_blue m_r3" style="background-color: #148cb2;" onClick="location.href='${pageContext.request.contextPath}/user/corp_car_log?carID=0'">전체일지</button>
                            <button class="btn_blue" style="position: absolute; height: 35.49px;background-color: #0099a4;" onClick="location.href='${pageContext.request.contextPath}/user/corp_car_management'">차량목록</button>	                            
                        </div>
                        ...
                        <table class="list clearfix">
                            ...
                            <c:forEach var="carUse" items="${list}" varStatus="status">
                                <tr>
                                    ...
                                    <td>
                                        <button class="s_btn_blue" style="background-color: #00136f;" id="updateUseBtn" name="updateUseBtn" onclick="updateUseBtn('${carUse.carPID}');">수정</button>
                                    </td>
                                </tr>
                            </c:forEach>                                  
                            </tbody>
