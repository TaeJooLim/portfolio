	            ...
	            <div class="main_right_info" style="padding: 30px 20px;">
	                <form id="frm" method="POST" action="${pageContext.request.contextPath}/user/client_reg">
	                    ...
	                    <div class="btn-grp center m_t30">
	                        <button type="submit" class="btn_blue" style="background-color: #00136f;" tabindex="23">거래처등록</button>
	                        <button type="reset" class="btn_ivory" tabindex="24">새로고침</button>
	                        <button type="button" class="btn_blue" style="background-color: #148cb2;" onClick="location.href='${pageContext.request.contextPath}/user/client_list'">목록으로</button>
	                    </div>
	                </form>
	            </div>
	        </div>
